...
const MdMenu = dynamic(() =>
  import("react-icons/md").then((mod) => mod.MdMenu)
);
  ...
  return (
    <nav className="max-w-7xl mx-auto">
      <div className="mx-auto px-6 lg:px-10 flex items-center justify-between min-h-20">
        {/* Heading */}
        <h1 className="text-xl md:text-2xl lg:text-3xl font-bold lg:font-extrabold text-black cursor-pointer">
          HEADLINEIQ
        </h1>
